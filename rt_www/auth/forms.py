...
from rt_www.auth import authenticate
...
class AuthenticationForm(forms.Manipulator):
    ...
    def __init__(self, request=None):
        ...
        self.fields = [
            forms.TextField(field_name="username", length=15, max_length=30, is_required=True,
                validator_list=[self.isValidUser, self.hasCookiesEnabled]),
            forms.PasswordField(field_name="password", length=15, max_length=30, is_required=True),
        ]
