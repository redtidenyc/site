...
class User(models.Model):
	...
	"""
	username = models.CharField(_('username'), max_length=30, unique=True, help_text=_("Required. 30 characters or fewer. Alphanumeric or Email is fine"))
	first_name = models.CharField(_('first name'), max_length=30, blank=True)
	last_name = models.CharField(_('last name'), max_length=30, blank=True)
	middle_initial = models.CharField(_('middle initial'), max_length=1, blank=True, default='')
	email = models.EmailField(_('e-mail address'), blank=True)
	password = models.CharField(_('password'), max_length=128, blank=True, help_text=_("Use '[algo]$[salt]$[hexdigest]'"))
	...
	filter_horizontal = ('permissions','user_permissions')
	objects = UserManager()
	class Meta:
		verbose_name = _('redtide_user')
		verbose_name_plural = _('redtide Users')
		ordering = ('first_name',)
	class Admin:
		fields = (
			(None, {'fields': ('username', 'password')}),
			(_('Personal info'), {'fields': ('first_name', 'middle_initial', 'last_name', 'email')}),
	...
	def save(self):
		...
		if not self.password:
			self.password = ''
		if '$' not in self.password and self.password != '':
