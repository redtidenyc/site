...
from rt_www.auth import models as auth_app
...
def create_permissions(app, created_models):
	...
	from rt_www.auth.models import Permission
...
def create_superuser(app, created_models):
	...
	from rt_www.auth.create_superuser import createsuperuser as do_create
