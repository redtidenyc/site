from rt_www.auth.forms import AuthenticationForm
from rt_www.auth.forms import PasswordResetForm, PasswordChangeForm
from django import forms
from django.shortcuts import render_to_response
from django.template import RequestContext
from django.contrib.sites.models import Site
from django.http import HttpResponseRedirect
from rt_www.auth.decorators import login_required
from rt_www.auth import LOGIN_URL, REDIRECT_FIELD_NAME
...
def logout(request, next_page=None, template_name='registration/logged_out.html'):
    ...
    from rt_www.auth import logout
    logout(request)
